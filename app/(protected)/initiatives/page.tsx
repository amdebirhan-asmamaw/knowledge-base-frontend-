        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-muted-foreground">
              Propose operational improvements, technological solutions, or cost
              savings
            </p>
          </div>
        </div>
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <div className="border border-input rounded-xl overflow-hidden shadow-xs">
              <RichTextEditor
                value={form.problem}
                onChange={(html) => setForm((f) => ({ ...f, problem: html }))}
...
// ─── Main Employee Initiatives Portfolio Page ────────────────────────────────
...
export default function EmployeeInitiativesPage() {
  ...
  const { createInitiative: createMut, updateInitiative: updateMut } =
    useInitiativeMutations();
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-7 pb-16">
          ...
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <h1 className="text-2xl font-bold text-foreground tracking-tight">
                Initiatives & Innovation Portfolio
              </h1>
              <p className="text-xs text-muted-foreground mt-0.5">
                Propose operational ideas, track evaluations, and collaborate
                across teams
              </p>
            </div>
          </div>
      ...
      <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2.5">
        <div className="relative flex-1">
          ...
          <Input
            ...
            placeholder="Search proposals by title, team, or author…"
          ...
          {Object.entries(STATUS_CONFIG).map(([val, cfg]) => {
            ...
            return (
              <button
                ...
                className={`px-3 py-2 rounded-xl font-medium whitespace-nowrap flex items-center gap-1.5 transition-all ${
                  isSelected
        ...
        <Card className="p-16 text-center border-dashed rounded-2xl">
          ...
          <p className="text-xs text-muted-foreground mt-1 max-w-sm mx-auto">
            {filterStatus || searchQuery
              ? "No initiatives match your search or status filter. Try resetting your query."
              : "No proposals have been submitted yet. Be the first to share an innovation!"}
          </p>
          {(filterStatus || searchQuery) && (
            <Button
              variant="outline"
