...
- [x] **Step 1: Update backend permissions.ts**
...
- [x] **Step 2: Update frontend permissions.ts**
...
- [x] **Step 1: Write role.migration.ts**
...
- [x] **Step 2: Connect migration into database.ts startup**
...
- [x] **Step 1: Update document.routes.ts**
...
- [x] **Step 2: Update document.service.ts for ownership and contributors**
...
- [x] **Step 3: Enforce in department.routes.ts**
...
- [x] **Step 4: Enforce in policy.routes.ts**
...
- [x] **Step 1: Gate category actions**
...
- [x] **Step 1: Update DocumentView.tsx**
...
- [x] **Step 2: Update DocumentEditor.tsx**
